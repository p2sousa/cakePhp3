...
class ProductsTagsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ProductsTags') ? [] : ['className' => ProductsTagsTable::class];
        $this->ProductsTags = TableRegistry::getTableLocator()->get('ProductsTags', $config);
    }
